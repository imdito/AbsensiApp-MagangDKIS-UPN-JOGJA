    ...
    <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md border border-gray-100">
        ...
        <form action="{{ route('bidang.update', $bidang->id_bidang) }}" method="POST">
            ...
            @if(auth()->user()->role == 'superadmin')
                {{-- Input ID skpd (Hanya untuk super Admin) --}}
               @include('layouts.skpdDropdown')
            @endif
            ...
            <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                <a href="{{ route('bidang.index') }}" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors">Batal</a>
